...
なお、再現する人が出てこないと踏んでいるためかなりの部分を省いて記載している。
...
|mini2_contours_Xfps.py|mini2用輪郭抽出アプリケーション|
|P2pro.py|Infiray P2 Pro用アプリケーション|
|P2pro_contours.py|P2 Pro用輪郭抽出アプリケーション|
...
### 自動起動設定
RPiZ2UVCカメラとしてサーマルユニットを使用する時、uvcvideoドライバをquirks=0x02でロードする必要がある。
