...
JLCPCBでの発注パラメータは例えば以下のようなものとなる。    
![image](https://github.com/gb7k/Day_Dream-Yume_Thermal-/assets/164740841/a2c09d9f-490c-4923-bc68-b2b83b5acc2e)
...
ハーネスの長さはおそらく6,70cmが限度だと思われるので余裕を見て50cmくらいで作成すること。  
必要な部材は下記の通りである。  
|部材名称|個数|型式|
| --- | --- | --- |
...
- 実行時にまれに映像が止まる問題が未解
    - CSピンがノイズで立ち上がってる……？GPIOはノイズに弱いので可能性としてはあり得る
    - SPIのクロックズレ……？データの整合性をどう取るか……
